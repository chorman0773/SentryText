 ...
 *  @see {@link github.chorman0773.sentry.text.I18N I18N} which provides the translation system to the game.
...
public abstract class TextComponent {
	...
	public static void setLang(I18N lang) {
		TextComponent.lang = lang;
	}
	
	public static I18N getLang() {
		return lang;
	}
	...
	public static class TranslatebleTextComponent extends TextComponent{
		...
		public TextComponent getAsFormatted() {
			return lang.translateAndFormat(this, new TextComponent[0]);
		}
		public TextComponent format(TextComponent[] args,int depth) {
			...
			return lang.translateAndFormat(this, nargs);
		}
		@Override
	...
	protected Point drawOnComponent(Component comp,Point start,Font f,Color c) {
		...
		graphics.setFont(f);
		graphics.setColor(c);
		String str = toUnformattedString();
		Rectangle rect = f.getStringBounds(str, graphics.getFontRenderContext()).getBounds();
		graphics.drawString(str, start.x,start.y);
	...
	private static final TextComponent EMPTY = new TextComponentString("");
	...
	public static TextComponent translate(String key) {
		return new TranslatebleTextComponent(key);
	}
	...
	public static Font defaultFont() {
		return new Style(EnumTextColor.white).getFont();
	}
}
